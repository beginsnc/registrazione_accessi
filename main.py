...
worksheet.cell(row=last_row, column=2).value = ora
worksheet.cell(row=last_row, column=3).value = nome_societa
worksheet.cell(row=last_row, column=4).value = nominativo
